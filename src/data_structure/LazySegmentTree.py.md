...
data:
  ...
  verifiedWith:
  - src/$tests/data_structure/lazysegtree.test.py
documentation_of: src/data_structure/LazySegmentTree.py
layout: document
redirect_from:
- /library/src/data_structure/LazySegmentTree.py
- /library/src/data_structure/LazySegmentTree.py.html
