...
data:
  ...
  verifiedWith: []
documentation_of: expansion/$tests/polynomial/pow_of_FormalPowerSeries.test.py
layout: document
redirect_from:
- /verify/expansion/$tests/polynomial/pow_of_FormalPowerSeries.test.py
- /verify/expansion/$tests/polynomial/pow_of_FormalPowerSeries.test.py.html
